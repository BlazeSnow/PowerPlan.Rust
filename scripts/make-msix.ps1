...
for ($i = 0; $i -lt $ArchList.Count; $i++) {
    ...
    Copy-Item $exePath (Join-Path $stageDir "PowerPlan.exe")
...
$bundleName    = "PowerPlan_$($Version)$suffix.msixbundle"
...
Write-Host "Identity: BlazeSnow.PowerPlan, CN=C171AF55-419C-4E73-B34E-CB98C8F1EB78, Version=$Version"
